...
import { AlertWarningIcon, CircleCheckIcon, CircleInfoIcon, CircleXmarkIcon, LoaderIcon } from "../icons"
import { buttonVariants } from "./button"

/** Maple's Nucleo set, matching what the old sonner wrapper passed as `icons`. */
const TOAST_ICONS = {
