...
import { CheckIcon, ChevronDownIcon, ChevronExpandYIcon, ChevronUpIcon } from "../icons"
	...
	const defaultProps = {
		children: (
			<>
				...
				<ChevronExpandYIcon className={selectTriggerIconClassName} />
			</>
		),
