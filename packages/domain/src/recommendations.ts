...
const ATTRIBUTE_RENAMES: readonly AttributeRename[] = [
	// HTTP
	{ deprecated: "http.method", canonical: "http.request.method", reason: "HTTP semconv renamed the request method attribute.", category: "deprecated" },
	{ deprecated: "http.status_code", canonical: "http.response.status_code", reason: "Response status moved under the http.response.* namespace.", category: "deprecated" },
	{ deprecated: "http.url", canonical: "url.full", reason: "Full request URL moved to the dedicated url.* namespace.", category: "deprecated" },
	{ deprecated: "http.target", canonical: "url.path", reason: "Request target split into url.path (and url.query).", category: "deprecated" },
	{ deprecated: "http.scheme", canonical: "url.scheme", reason: "Scheme moved to the url.* namespace.", category: "deprecated" },
	{ deprecated: "http.host", canonical: "server.address", reason: "Host attribute generalized to server.address.", category: "deprecated" },
	{ deprecated: "http.flavor", canonical: "network.protocol.version", reason: "Protocol version generalized under network.*.", category: "deprecated" },
	{ deprecated: "http.request_content_length", canonical: "http.request.body.size", reason: "Renamed in the stable HTTP semconv.", category: "deprecated" },
	{ deprecated: "http.response_content_length", canonical: "http.response.body.size", reason: "Renamed in the stable HTTP semconv.", category: "deprecated" },
	{ deprecated: "http.user_agent", canonical: "user_agent.original", reason: "User agent moved to the user_agent.* namespace.", category: "deprecated" },
	// Network / socket
	{ deprecated: "net.peer.name", canonical: "server.address", reason: "Peer name generalized to server.address.", category: "deprecated" },
	{ deprecated: "net.peer.port", canonical: "server.port", reason: "Peer port generalized to server.port.", category: "deprecated" },
	{ deprecated: "net.host.name", canonical: "server.address", reason: "Host name generalized to server.address.", category: "deprecated" },
	{ deprecated: "net.host.port", canonical: "server.port", reason: "Host port generalized to server.port.", category: "deprecated" },
	{ deprecated: "net.sock.peer.addr", canonical: "network.peer.address", reason: "Socket peer address moved to network.*.", category: "deprecated" },
	{ deprecated: "net.sock.peer.port", canonical: "network.peer.port", reason: "Socket peer port moved to network.*.", category: "deprecated" },
	{ deprecated: "net.transport", canonical: "network.transport", reason: "Transport moved to the network.* namespace.", category: "deprecated" },
	{ deprecated: "net.protocol.name", canonical: "network.protocol.name", reason: "Protocol name moved to network.*.", category: "deprecated" },
	{ deprecated: "net.protocol.version", canonical: "network.protocol.version", reason: "Protocol version moved to network.*.", category: "deprecated" },
	// Database
	{ deprecated: "db.statement", canonical: "db.query.text", reason: "Database semconv renamed the statement attribute.", category: "deprecated" },
	{ deprecated: "db.operation", canonical: "db.operation.name", reason: "Renamed in the stable database semconv.", category: "deprecated" },
	{ deprecated: "db.system", canonical: "db.system.name", reason: "Database system attribute namespaced as db.system.name.", category: "deprecated" },
	{ deprecated: "db.name", canonical: "db.namespace", reason: "Database name generalized to db.namespace.", category: "deprecated" },
	{ deprecated: "db.sql.table", canonical: "db.collection.name", reason: "Table/collection name generalized to db.collection.name.", category: "deprecated" },
	// Messaging
	{ deprecated: "messaging.destination", canonical: "messaging.destination.name", reason: "Destination namespaced under messaging.destination.*.", category: "deprecated" },
	{ deprecated: "messaging.url", canonical: "server.address", reason: "Broker URL generalized to server.address.", category: "deprecated" },
	{ deprecated: "messaging.protocol", canonical: "network.protocol.name", reason: "Messaging protocol moved to network.*.", category: "deprecated" },
	{ deprecated: "messaging.protocol_version", canonical: "network.protocol.version", reason: "Messaging protocol version moved to network.*.", category: "deprecated" },
	// FaaS / user
	{ deprecated: "faas.execution", canonical: "faas.invocation_id", reason: "FaaS execution id renamed to faas.invocation_id.", category: "deprecated" },
	{ deprecated: "enduser.id", canonical: "user.id", reason: "Enduser attributes consolidated under user.*.", category: "deprecated" },
	// Common camelCase mistakes with a confident canonical target
	{ deprecated: "httpMethod", canonical: "http.request.method", reason: "Non-conforming camelCase key — use the dotted semconv name.", category: "camelcase" },
	{ deprecated: "httpStatusCode", canonical: "http.response.status_code", reason: "Non-conforming camelCase key — use the dotted semconv name.", category: "camelcase" },
	{ deprecated: "httpUrl", canonical: "url.full", reason: "Non-conforming camelCase key — use the dotted semconv name.", category: "camelcase" },
	{ deprecated: "httpRoute", canonical: "http.route", reason: "Non-conforming camelCase key — use the dotted semconv name.", category: "camelcase" },
	{ deprecated: "dbStatement", canonical: "db.query.text", reason: "Non-conforming camelCase key — use the dotted semconv name.", category: "camelcase" },
	{ deprecated: "dbOperation", canonical: "db.operation.name", reason: "Non-conforming camelCase key — use the dotted semconv name.", category: "camelcase" },
	{ deprecated: "userId", canonical: "user.id", reason: "Non-conforming camelCase key — use the dotted semconv name.", category: "camelcase" },
]
