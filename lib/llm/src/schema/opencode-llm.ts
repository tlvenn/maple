// Inlined from opencode `packages/schema/src/llm.ts` (plus the `optional` helper from
// `packages/schema/src/schema.ts`) so that `@maple/llm` does not depend on the unpublished
// `@opencode-ai/schema` workspace package. See ../../MAPLE.md.
