# Agent setup for `maple`

This is a deepsec scanning workspace. Project `maple` was just registered
(target: `..`). Setup is incomplete — `data/maple/INFO.md`
...
```bash
pnpm deepsec scan    --project-id maple
pnpm deepsec process --project-id maple
```
